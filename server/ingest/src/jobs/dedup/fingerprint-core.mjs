 ...
 *
 * Ported from career-ops (https://github.com/santifer/career-ops), MIT License.
...
/** Unicode-aware company matching key — adaptation of tracker-parse.mjs
 * `normalizeTextKey` (#2569/#2666). Kept here so this file stays a single
 * self-contained module: NFKC, lower, strip combining dot, keep letters,
 * marks and numbers. */
function normalizeTextKey(value, separator = '') {
  return String(value ?? '')
    .normalize('NFKC')
    .toLowerCase()
    .replace(/̇/gu, '')
