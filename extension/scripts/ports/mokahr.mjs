...
const AES_IV_STRING = 'de7c21ed8d6f50fe';
...
export function decryptMokaHrEnvelope(envelope) {
  ...
  if (typeof Buffer === 'undefined' || typeof createDecipheriv !== 'function') {
    throw new Error('mokahr: AES decryption requires Node crypto/Buffer environment');
  }
  ...
  const iv = Buffer.from(AES_IV_STRING, 'utf8');
